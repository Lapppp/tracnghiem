...
$config['licenseName'] = 'kenjivietnam.vn';
$config['licenseKey']  = 'KSYS2PGLBFRBTC2L4CVAT57QGN1C3';
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,doc,docx,ods,odt,pdf,png,ppt,pptx,xls,xlsx,txt,zip,tar,tgz,rar',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
