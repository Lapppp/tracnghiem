    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Danh sách Administrator</span>
            </h3>
            <div class="card-toolbar">
                @if(Auth::guard('backend')->user()->can(['create_admins']))
                <a href="{{ Route('backend.admin.create') }}" class="btn btn-sm btn-light-primary">
            ...
            <div class="table-responsive">
                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-200px">Ngày cập nhật</th>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            @if(Auth::guard('backend')->user()->can(['edit_admins']))
                                                <a href="{{ Route('backend.admin.edit',['id'=>$item->id]) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $item->name }}</a>
                                            @else
                                                <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $item->name }}</a>
                                            @endif

                                                <span style="display: none!important;" class="text-muted fw-bold text-muted d-block fs-7">{{$item->getRoleNames()}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
