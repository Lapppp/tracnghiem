@if(Auth::guard('backend')->user()->canany(['list_question','list_question_all','question_create','question_delete','question_edit']))
    <div data-kt-menu-trigger="click" class="menu-item @if($controller =='QuestionController') show @endif menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion">
            ...
            @if(Auth::guard('backend')->user()->can(['list_question_all']))
                <div class="menu-item">
                    <a class="menu-link @if($actionName =='index' && $controller =='QuestionController') active @endif" href="{{ Route('backend.question.index') }}">
            ...
            @if(Auth::guard('backend')->user()->can(['question_create']))
                <div class="menu-item">
                    <a class="menu-link @if($actionName =='create' && $controller =='QuestionController') active @endif" href="{{ Route('backend.question.create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
