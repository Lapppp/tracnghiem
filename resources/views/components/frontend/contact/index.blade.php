        ...
        <div class="container">
            ...
            <div class="main__contact--area position__relative">
                ...
                <div class="contact__form">
                    <h3 class="contact__form--title mb-40">Liên hệ với tôi, vui lòng nhập thông tin bên dưới</h3>
                ...
                <div class="contact__info border-radius-5">
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white">Liên hệ qua số <br>
                                    @if($contact->hotline)
                                         <a href="tel:{{ $contact->hotline ?? '' }}">{{ $contact->hotline ?? '' }}</a>
                                    @endif
                                    @if($contact->advise)
                                        <a href="tel:{{ $contact->advise ?? '' }}">{{ $contact->advise ?? '' }}</a>
                                    @endif
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"><a href="mailto:{{ $contact->insurance }}">{{ $contact->insurance }}</a>
                                    <br> <a href="mailto:{{ $contact->email }}">{{ $contact->email }}</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
