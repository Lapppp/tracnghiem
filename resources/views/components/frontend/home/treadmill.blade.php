<section class="a4 s-chaybo 11">
    <div class="ctn">
        <div class="title1">
            <h2>{{ $treadmillCategory->name ?? '' }}</h2>
        </div>

        <div class="pro-content">
            @foreach($treadmillCategory->productsActive()->limit(4)->get() as $post)
        ...
        <a href="{{ Route('frontend.product.edit',['slug'=>'hang-trung-bay-thanh-ly']) }}" class="seemore">Xem toàn bộ sản phẩm</a>
    </div>
</section>
