            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        <h1 class="breadcrumb__content--title text-white mb-25">{{ $post->name ?? '' }}</h1>
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.html">Trang chủ</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="text-white">{{ $post->name ?? '' }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="blog__details--wrapper">
                        ...
                        <div class="blog__tags--social__media d-flex align-items-center justify-content-between" >
                            <div class="blog__tags--media d-flex align-items-center" >
                                <label class="blog__tags--media__title" style="display: none !important">Releted Tags :</label>
                        ...
                        @if(count($otherSameNews) > 0)
                        <div class="related__post--area">
                            <div class="section__heading text-center mb-30">
                                <h2 class="section__heading--maintitle">Các tin khác</h2>
                            </div>
                                    ...
                                    <div class="col mb-28">
                                        <div class="related__post--items">
                                            <div class="related__post--thumb border-radius-10 mb-15">
                                                <a class="display-block" href="{{ Route('frontend.news.show',['id'=>$item->id,'name'=>Str::slug($item->name.'', '-').'.html']) }}">
                                                    @if($item->default() && $item->default()['url'])
                                                        <img
                                                            src="{{ str_replace(Str::of($item->default()['url'])->basename(),'thumb_'.Str::of($item->default()['url'])->basename(),asset('storage/products/'.$item->default()['url'])) }}"
                                                            alt="{{ $item->name ?? '' }}"
                        ...
                        <div class="comment__box" style="display:none !important;">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4">
                    <div class="blog__sidebar--widget left widget__area">
                        ...
                        <div class="single__widget widget__bg" style="display:none !important;">
                        ...
                        <div class="single__widget widget__bg">
                            <h2 class="widget__title h3">Tin Mới</h2>
                                ...
                                @foreach($otherNews as $key =>$value)
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="{{ Route('frontend.news.show',['id'=>$value->id,'name'=>Str::slug($value->name.'', '-').'.html']) }}">
                                                @if($value->default() && $value->default()['url'])
                                                    <img class="product__grid--items__img product__primary--img" src="{{ str_replace(Str::of($value->default()['url'])->basename(),'thumb_50x50_'.Str::of($value->default()['url'])->basename(),asset('storage/products/'.$value->default()['url'])) }}" alt="product-img">
                                                @endif
