            ...
            <div class="cmd12 single-prd">
                ...
                <div class="cmd4 sidebar-prd">
                    ...
                    <div class="dmsibar">
                        ...
                        <ul>
                            <li>
                                <a href="https://kenjisport.com/tin-tuc/">
                        Tin tức
                        </a></li></ul>
                    </div>
                    ...
                    <div class="dmsibar">
                        ...
                        <ul>
                            @foreach($otherNews as $key => $value)
                                <li>
                                    <a href="{{ !empty($value->slug) ?  Route('frontend.product.edit',['slug'=>$value->slug]) : '#' }}">{{ $value->name }}</a>
                                </li>
                            @endforeach
        ...
        <div class="cmd12" id="recent-prd">
            ...
            <div id="sl-recentprd">
                @foreach($otherSameNews as $key => $item)
                    <div class="cmd4">
                        <div class="it-post">
                            <a href="{{ !empty($item->slug) ?  Route('frontend.product.edit',['slug'=>$item->slug]) : '#' }}">
                            ...
                            <h3><a href="{{ !empty($item->slug) ?  Route('frontend.product.edit',['slug'=>$item->slug]) : '#' }}">{{ $item->name ?? '' }}</a></h3>
