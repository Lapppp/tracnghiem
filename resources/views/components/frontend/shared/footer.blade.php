...
<footer class="footer__section bg__black">
    <div class="container-fluid">
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content text-ofwhite m-0">Copyright © {{ date('Y') }} <a class="copyright__content--link" href="{{ Route('frontend.home.index') }}">Luyện thi công chức</a> . All Rights Reserved.Design By Suruchi</p>
        </div>
    </div>
</footer>
<!-- End footer section -->
