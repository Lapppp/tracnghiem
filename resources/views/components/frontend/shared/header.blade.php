    ...
    <div class="main__header header__sticky">
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                        ...
                        <div class="header__select--categories select">
                            <select class="header__select--inner" name="category_id" id="category_id">
                                ...
                                @foreach($menuCategory as $category)
                                    <option value="{{ $category->id ?? 0 }}" @if($category_id ==$category->id) selected="selected" @endif>{{ $category->name ?? '' }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="header__account d-none header__sticky--none">
                    <ul class="d-flex">
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items style2">
                                ...
                                @if(!Auth::guard('web')->user())
                                    <a class="header__menu--link" href="{{ Route('frontend.auth.login') }}">Đăng nhập</a>
                                @else
                                    <a class="header__menu--link" href="#"><b>{{ Auth::guard('web')->user()->name ?? '' }}</b>
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12"
                                             height="7.41" viewBox="0 0 12 7.41">
                                            <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z"
                                                  transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        @if(!Auth::guard('web')->user())
                            <a class="offcanvas__menu_item" href="{{ Route('frontend.auth.login') }}">Đăng nhập</a>
                        @else
                ...
                <div class="offcanvas__account--items">
                    <a class="offcanvas__account--items__btn d-flex align-items-center" href="{{ Route('frontend.auth.login') }}">
                ...
                <div class="language__currency" style="display: none !important;">
