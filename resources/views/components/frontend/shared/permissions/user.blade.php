@if(Auth::guard('backend')->user()->canany(['list_user_all','list_user','create_user','delete_user','edit_user']))
<div data-kt-menu-trigger="click" class="menu-item @if($controller =='UserController') show @endif menu-accordion">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        ...
        <div class="menu-item">
            <a class="menu-link @if($actionName =='index' && $controller =='UserController' ) active @endif " href="{{ Route('frontend.user.index') }}">
        ...
        <div class="menu-item">
            <a class="menu-link @if($actionName =='create' && $controller =='UserController') active @endif " href="{{ Route('backend.users.create') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
