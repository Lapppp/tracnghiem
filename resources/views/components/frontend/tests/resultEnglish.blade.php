<x-layout.question>
    ...
    <form class="multisteps_form bg-white position-relative overflow-hidden" style="max-width: none;background: none" id="wizard" method="POST" action="">
        ...
        <div class="mt-2 p-3"><p class="m-0">Số câu đúng của bạn: <span class="badge bg-primary">{{ $so_cau_dung->total ?? 0 }}</span></p></div>
                                        ...
                                        <div class="col-6">
                                            <ul class="list-unstyled p-0">
                                                <?php
                                                    ...
                                                    ?>
                                                <li  class="step_1 animate__animated animate__fadeInRight @if(isset($check->user_chosen) && ($check->user_chosen == $answer->id) ) active @endif"
