...
<head><base href="../../">
    <title>KenJi</title>
    <meta name="description" content="TKenJi" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-center flex-column-fluid p-10">
        ...
        <!--end::Illustration-->
        <!--begin::Message-->
        <h1 class="fw-bold mb-10" style="color: #A3A3C7">KenJi</h1>
        <!--end::Message-->
        <!--begin::Link-->
        <a href="{{Route('backend.dashboard.index')}}" class="btn btn-primary">KenJi</a>
        <!--end::Link-->
    </div>
